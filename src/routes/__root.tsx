...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Connectivity — SIMs prepago 5G con gigas acumulables" },
      {
        name: "description",
        content:
          "SIMs prepago Connectivity: 80 GB o 150 GB acumulables, llamadas ilimitadas y 1.000 min internacionales. Sin permanencia, red 5G.",
      },
      { name: "author", content: "Connectivity" },
      { property: "og:title", content: "Connectivity — SIMs prepago 5G con gigas acumulables" },
      {
