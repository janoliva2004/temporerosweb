...
const es = {
  ...
  contact: {
    badge: "Contacto",
    title: "¿Hablamos?",
    subtitle: "Escríbenos y te ayudamos con tu plan, tu SIM física o cualquier duda.",
    name: "Nombre",
    namePh: "Tu nombre",
    email: "Email",
...
const en: Dict = {
  ...
  contact: {
    badge: "Contact",
    title: "Let's talk?",
    subtitle: "Write to us and we'll help you with your plan, your physical SIM or any questions.",
    name: "Name",
    namePh: "Your name",
    email: "Email",
    ...
    errTitle: "The message couldn't be sent",
...
const fr: Dict = {
  ...
  contact: {
    badge: "Contact",
    title: "On discute ?",
    subtitle: "Écris-nous et on t'aide avec ton forfait, ta SIM physique ou toute question.",
    name: "Nom",
    namePh: "Ton nom",
    email: "Email",
    emailPh: "toi@email.com",
    message: "Message",
    messagePh: "Comment pouvons-nous t'aider ?",
    send: "Envoyer le message",
    sending: "Envoi…",
    successTitle: "Message envoyé !",
    successDesc: "Nous te répondrons dès que possible.",
    errTitle: "Le message n'a pas pu être envoyé",
